...
tmp_path = "/mnt/ubuntu_data_hdd/school/masters/uwaterloo/1b/cs885/project/codenames/codenames_ai/logs/gridtest_longer/sb3_log/"
# set up logger
...
def make_env(env_name):
    ...
    return Monitor(GridTestEnv(), str(log_dir))
...
models = dict(
    ...
    #     buffer_size=int(1e6)
    # ),
    ppo = PPO('MlpPolicy', make_env("ppo"), verbose=1, n_steps=100, n_epochs=80),
    a2c = A2C('MlpPolicy', make_env("a2c"), verbose=1, n_steps=100)
)
...
results_plotter.plot_results(
    ...
    None, results_plotter.X_TIMESTEPS, "Gridtest - n_steps=100"
)
plt.legend(loc="best", labels=["PPO", "avg(PPO)", "A2C", "avg(A2C)"])
plt.grid()
plt.savefig("gridtest_longer_sb3.png")
