...
tmp_path = "/mnt/ubuntu_data_hdd/school/masters/uwaterloo/1b/cs885/project/codenames/codenames_ai/logs/gridtest_onemove/sb3_log/"
# set up logger
...
results_plotter.plot_results(
    ...
    None, results_plotter.X_TIMESTEPS, "Gridtest - One move"
)
plt.legend(loc="best", labels=["PPO", "avg(PPO)", "A2C", "avg(A2C)"])
plt.grid()
plt.savefig("gridtest_onemove_sb3.png")
