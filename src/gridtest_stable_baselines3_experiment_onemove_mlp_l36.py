...
env_checker.check_env(GridTestOneMoveEnv(length=36))

from stable_baselines3.common.logger import configure
import pathlib

EXPERIMENT_NAME = "gridtest_onemove_mlp_l36"
EXPERIMENT_DISPLAY_NAME = "Gridtest - One move - MLP - Length 36"
...
def make_env(env_name):
    ...
    return Monitor(GridTestOneMoveEnv(length=36), str(log_dir))
