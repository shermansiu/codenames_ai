...
env_checker.check_env(WhackAMoleMultiBinaryEnv())

from stable_baselines3.common.logger import configure
import pathlib

EXPERIMENT_NAME = "whackamole_multibinary"
EXPERIMENT_DISPLAY_NAME = "Whack-A-Mole - Multibinary"
...
def make_env(env_name):
    ...
    return Monitor(WhackAMoleMultiBinaryEnv(), str(log_dir))
