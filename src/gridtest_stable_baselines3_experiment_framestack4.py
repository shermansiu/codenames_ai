...
env_checker.check_env(GridTestStackedEnv())

from stable_baselines3.common.logger import configure
import pathlib

EXPERIMENT_NAME = "gridtest_framestack4"
EXPERIMENT_DISPLAY_NAME = "Gridtest - Frame stack 4"
...
def make_env(env_name):
    ...
    return Monitor(GridTestStackedEnv(), str(log_dir))
