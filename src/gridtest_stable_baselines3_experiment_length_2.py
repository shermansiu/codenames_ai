...
env_checker.check_env(GridTestEnv(length=2))

from stable_baselines3.common.logger import configure
import pathlib

tmp_path = "/mnt/ubuntu_data_hdd/school/masters/uwaterloo/1b/cs885/project/codenames/codenames_ai/logs/gridtest_l2/sb3_log/"
# set up logger
...
def make_env(env_name):
    ...
    return Monitor(GridTestEnv(length=2), str(log_dir))
...
results_plotter.plot_results(
    ...
    None, results_plotter.X_TIMESTEPS, "Gridtest - Length 2"
)
plt.legend(loc="best", labels=["PPO", "avg(PPO)", "A2C", "avg(A2C)"])
plt.grid()
plt.savefig("gridtest_l2_sb3.png")
