...
env_checker.check_env(GridTestLinearRewardEnv())

from stable_baselines3.common.logger import configure
import pathlib

EXPERIMENT_NAME = "gridtest_linear_reward"
EXPERIMENT_DISPLAY_NAME = "Gridtest - Linear Reward"
...
def make_env(env_name):
    ...
    return Monitor(GridTestLinearRewardEnv(), str(log_dir))
