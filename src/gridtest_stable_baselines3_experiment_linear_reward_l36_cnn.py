...
env_checker.check_env(GridTestLinearRewardEnv(length=36))

from stable_baselines3.common.logger import configure
import pathlib

EXPERIMENT_NAME = "gridtest_linear_reward_l36_cnn"
EXPERIMENT_DISPLAY_NAME = "Gridtest - Linear Reward - Length 36 - CNN"
...
def make_env(env_name):
    ...
    return Monitor(GridTestLinearRewardEnv(length=36), str(log_dir))
